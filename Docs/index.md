# Connector for Microsoft Azure and Microsoft Graph

This app provides tools to connect to Microsoft Azure.

- Authentication in Azure 
  - Authenticating users via Single-sign-on (SSO) with Azure - easy secure login option with Azure credentials
      - [SSO via OAuth 2.0](Single-Sign-On_with_Azure_via_OAuth.md)
      - [SSO via SAML](Single-Sign-On_with_Azure_via_SAML.md)
  - [Authenticating APIs (web services) in Azure](Authenticating_APIs_in_Azure.md)
  - [Accessing other services in Azure](Accessing_other_services_and_APIs_in_Azure.md)
